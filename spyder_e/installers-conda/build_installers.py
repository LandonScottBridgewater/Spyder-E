...
def _process_extra_specs(extra_specs, no_local=False):
    ...
    specs = {"spyder_e": ["=", parse(get_version(SPYREPO)).public]}
    ...
    if not no_local:
        ...
        for pkg in (
            "spyder_e", "spyder-kernels", "qtconsole", "python-lsp-server"
        ):
...
def _generate_background_images(install_type, spy_ver):
    ...
    logo_path = SPYREPO / "img_src" / "spyder_e.png"
