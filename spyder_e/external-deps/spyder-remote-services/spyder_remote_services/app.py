...
from spyder_e_remote_services.services import handlers
from spyder_e_remote_services.services.spyder_kernels.patches import (
    patch_main_kernel_handler,
    patch_maping_kernel_manager,
)
from spyder_e_remote_services.utils import get_free_port


class SpyderServerApp(ServerApp):
    spyder_server_info_file = "jpserver-spyder_e.json"
