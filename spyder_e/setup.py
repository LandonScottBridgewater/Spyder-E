...
from spyder_e import __version__, __website_url__  #analysis:ignore
...
def get_data_files():
    ...
    if sys.platform.startswith('linux'):
        data_files = [('share/applications', ['scripts/spyder_e.desktop']),
                      ('share/icons', ['img_src/spyder_e.png']),
                      ('share/metainfo',
                       ['scripts/org.spyder_ide.spyder_e.appdata.xml'])]
    elif os.name == 'nt':
        data_files = [('scripts', ['img_src/spyder_e.ico'])]
    else:
        data_files = []
...
SCRIPTS.append('spyder_e')

if os.name == 'nt':
    SCRIPTS += ['spyder_e.bat']
...
setup_args = dict(
    ...
    author_email="spyder_e.python@gmail.com",
    url=__website_url__,
    license='MIT',
...
spyder_plugins_entry_points = [
    'appearance = spyder_e.plugins.appearance.plugin:Appearance',
    'application = spyder_e.plugins.application.plugin:Application',
    'completions = spyder_e.plugins.completion.plugin:CompletionPlugin',
    'debugger = spyder_e.plugins.debugger.plugin:Debugger',
    'editor = spyder_e.plugins.editor.plugin:Editor',
    'explorer = spyder_e.plugins.explorer.plugin:Explorer',
    'external_terminal = spyder_e.plugins.externalterminal.plugin:ExternalTerminal',
    'find_in_files = spyder_e.plugins.findinfiles.plugin:FindInFiles',
    'help = spyder_e.plugins.help.plugin:Help',
    'internal_console = spyder_e.plugins.console.plugin:Console',
    'ipython_console = spyder_e.plugins.ipythonconsole.plugin:IPythonConsole',
    'layout = spyder_e.plugins.layout.plugin:Layout',
    'main_interpreter = spyder_e.plugins.maininterpreter.plugin:MainInterpreter',
    'mainmenu = spyder_e.plugins.mainmenu.plugin:MainMenu',
    'onlinehelp = spyder_e.plugins.onlinehelp.plugin:OnlineHelp',
    'outline_explorer = spyder_e.plugins.outlineexplorer.plugin:OutlineExplorer',
    'plots = spyder_e.plugins.plots.plugin:Plots',
    'preferences = spyder_e.plugins.preferences.plugin:Preferences',
    'profiler = spyder_e.plugins.profiler.plugin:Profiler',
    'project_explorer = spyder_e.plugins.projects.plugin:Projects',
    'pylint = spyder_e.plugins.pylint.plugin:Pylint',
    'pythonpath_manager = spyder_e.plugins.pythonpath.plugin:PythonpathManager',
    'remoteclient = spyder_e.plugins.remoteclient.plugin:RemoteClient',
    'run = spyder_e.plugins.run.plugin:Run',
    'shortcuts = spyder_e.plugins.shortcuts.plugin:Shortcuts',
    'statusbar = spyder_e.plugins.statusbar.plugin:StatusBar',
    'switcher = spyder_e.plugins.switcher.plugin:Switcher',
    'toolbar = spyder_e.plugins.toolbar.plugin:Toolbar',
    'tours = spyder_e.plugins.tours.plugin:Tours',
    'update_manager = spyder_e.plugins.updatemanager.plugin:UpdateManager',
    'variable_explorer = spyder_e.plugins.variableexplorer.plugin:VariableExplorer',
    'workingdir = spyder_e.plugins.workingdirectory.plugin:WorkingDirectory',
]

spyder_completions_entry_points = [
    ('fallback = spyder_e.plugins.completion.providers.fallback.provider:'
     'FallbackProvider'),
    ('snippets = spyder_e.plugins.completion.providers.snippets.provider:'
     'SnippetsProvider'),
    ('lsp = spyder_e.plugins.completion.providers.languageserver.provider:'
...
setup_args['entry_points'] = {
    'gui_scripts': [
            'spyder_e = spyder_e.app.start:main'
    ],
    'spyder_e.plugins': spyder_plugins_entry_points,
    'spyder_e.completions': spyder_completions_entry_points
}
