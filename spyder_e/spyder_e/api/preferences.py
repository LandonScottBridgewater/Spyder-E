...
# Local imports
from spyder_e.api.utils import PrefixedTuple
from spyder_e.config.manager import CONF
from spyder_e.config.types import ConfigurationKey
from spyder_e.widgets.config import SpyderConfigPage, BaseConfigTab

if TYPE_CHECKING:
    from qtpy.QtGui import QIcon

    from spyder_e.api.plugins import SpyderPluginV2
    import spyder_e.plugins.preferences.widget


OptionSet: TypeAlias = set[ConfigurationKey]
"""Type alias for a set of keys mapping to valid Spyder configuration values.

A :class:`set` of :class:`spyder_e.config.types.ConfigurationKey`\\s.
"""
...
class SpyderPreferencesTab(BaseConfigTab):
    ...
    All calls to :class:`spyder_e.widgets.config.SpyderConfigPage` attributes
    ...
    def __init__(self, parent: SpyderConfigPage) -> None:
        ...
        Parameters
        ----------
        parent : spyder_e.widgets.config.SpyderConfigPage
    ...
    def apply_settings(self) -> OptionSet:
        ...
        OptionSet
            ...
            :class:`~spyder_e.config.types.ConfigurationKey`\\s that were
            manually applied.
        """
        return set({})
...
class PluginConfigPage(SpyderConfigPage):
    ...
    def __init__(
        ...
        parent: spyder_e.plugins.preferences.widget.ConfigDialog,
    ) -> None:
        """
        ...
        parent : spyder_e.plugins.preferences.widgets.configdialog.ConfigDialog
