...
from spyder_e.api.plugin_registration._confpage import PluginsConfigPage
...
class SpyderPluginRegistry(QObject, PreferencesAdapter):
    ...
    def _instantiate_spyder_plugin(
        ...
        if external:
            # These attributes come from spyder_e.app.find_plugins
