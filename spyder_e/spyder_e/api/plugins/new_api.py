...
from spyder_e.api.plugin_registration.mixins import SpyderPluginObserver
from spyder_e.api.widgets.main_widget import PluginMainWidget
from spyder_e.api.widgets.mixins import SpyderActionMixin
from spyder_e.api.widgets.mixins import SpyderWidgetMixin
from spyder_e.app.cli_options import get_options
from spyder_e.config.gui import get_color_scheme, get_font
from spyder_e.config.user import NoDefault
from spyder_e.utils.icon_manager import ima
from spyder_e.utils.image_path_manager import IMAGE_PATH_MANAGER
...
class SpyderPluginV2(QObject, SpyderActionMixin, SpyderConfigurationObserver,
    ...
    # config system (i.e. in spyder_e.ini)
    CONF_SECTION = None
    ...
    #       `spyder_e.pluginsl.layout.api::BaseGridLayoutType`
    CUSTOM_LAYOUTS = []
