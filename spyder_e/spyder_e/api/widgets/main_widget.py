...
from spyder_e.api.widgets import PluginMainWidgetActions, PluginMainWidgetWidgets
from spyder_e.api.widgets.auxiliary_widgets import (MainCornerWidget,
                                                  SpyderWindowWidget)
from spyder_e.api.widgets.menus import (
    PluginMainWidgetOptionsMenu,
    OptionsMenuSections,
    PluginMainWidgetMenus
)
from spyder_e.api.widgets.mixins import SpyderWidgetMixin
from spyder_e.api.widgets.toolbars import MainWidgetToolbar
from spyder_e.utils.qthelpers import create_waitspinner, qbytearray_to_str
from spyder_e.utils.registries import ACTION_REGISTRY, TOOLBAR_REGISTRY
from spyder_e.utils.stylesheet import (
    AppStyle, APP_STYLESHEET, PANES_TABBAR_STYLESHEET,
    PANES_TOOLBAR_STYLESHEET)
from spyder_e.widgets.dock import DockTitleBar, SpyderDockWidget
...
class PluginMainWidget(QWidget, SpyderWidgetMixin):
    ...
    Parameters
    ----------
    plugin_instance: spyder_e.api.plugins.SpyderDockablePlugin
