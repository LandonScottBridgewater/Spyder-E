...
# Local imports
from spyder_e.config.manager import CONF, CONF_VERSION
...
class SpyderConfigurationAccessor:
    ...
    def get_conf(
        ...
        Parameters
        ----------
        option: spyder_e.config.types.ConfigurationKey
            Name/tuple path of the configuration option value to get.
        default: spyder_e.config.user.NoDefault | BasicTypes, optional
    ...
    def get_conf_default(
        ...
        Returns
        -------
        spyder_e.config.user.NoDefault | BasicTypes
            The ``option``'s default value, or
            :class:`spyder_e.config.user.NoDefault` if one is not set.
        """
        section = self.CONF_SECTION if section is None else section
        if section is None:
            raise AttributeError(
    ...
    def spyder_conf_version(self) -> str:
        ...
        -------
        str
            The current Spyder :const:`spyder_e.config.manager.CONF_VERSION`,
    ...
    def old_spyder_conf_version(self) -> str:
        ...
        -------
        str
            The previous Spyder :const:`spyder_e.config.manager.CONF_VERSION`
...
class SpyderConfigurationObserver(SpyderConfigurationAccessor):
    ...
    :func:`~spyder_e.api.config.decorators.on_conf_change` decorator,
    ...
    def add_configuration_observer(
        ...
        - This is only necessary if you need to add a callable that is not a
          ...
          :func:`~spyder_e.api.config.decorators.on_conf_change`.
        """
        if section is None:
