...
from spyder_e.utils.installers import InstallerInternalError
from spyder_e.config.base import DEV, get_debug_level
from spyder_e.plugins.console.widgets.internalshell import InternalShell
from spyder_e.utils.environ import EnvDialog
from spyder_e.utils.misc import (get_error_match, getcwd_or_home,
                               remove_backslashes)
from spyder_e.utils.qthelpers import DialogManager, mimedata2url
from spyder_e.widgets.collectionseditor import CollectionsEditor
from spyder_e.widgets.findreplace import FindReplace
from spyder_e.widgets.reporterror import SpyderErrorDialog
...
class ConsoleWidget(PluginMainWidget):
    ...
    def handle_exception(self, error_data, sender=None):
        ...
        sender: spyder_e.api.plugins.SpyderPluginV2, optional
