...
from spyder_e.plugins.pylint.plugin import Pylint
...
def test_pylint_widget_pylintrc(
    ...
    mocker.patch("os.path.expanduser",
                 return_value=search_paths[HOME_DIR])
    mocker.patch("spyder_e.plugins.pylint.main_widget.getcwd_or_home",
                 return_value=search_paths[WORKING_DIR])
    mocker.patch("spyder_e.plugins.pylint.main_widget.osp.expanduser",
                 return_value=search_paths[HOME_DIR])
...
def test_get_environment(mocker):
    ...
    if os.name == 'nt':
        mocker.patch(
            "spyder_e.plugins.pylint.main_widget.is_conda_env",
            return_value=False
        )
        mocker.patch(
            "spyder_e.plugins.pylint.main_widget.get_home_dir",
            return_value=''
        )
