...
# Local imports
from spyder_e.api.fonts import SpyderFontType, SpyderFontsMixin
...
from spyder_e.plugins.remoteclient.widgets.connectionstatus import (
    ConnectionStatusWidget,
)
from spyder_e.utils.icon_manager import ima
from spyder_e.utils.stylesheet import AppStyle, MAC, WIN
from spyder_e.widgets.config import SpyderConfigPage
from spyder_e.widgets.helperwidgets import MessageLabel, TipWidget

try:
    from spyder_env_manager.spyder_e.widgets.new_environment import (
        NewEnvironment,
    )
    from spyder_env_manager.spyder_e.widgets.edit_environment import (
        EditEnvironment,
    )
    ENV_MANAGER = True
except Exception:
