...
from spyder_e.plugins.ipythonconsole import SPYDER_KERNELS_VERSION
from spyder_e.config.base import running_remoteclient_tests
from spyder_e.plugins.remoteclient import SPYDER_REMOTE_VERSION
...
def get_server_version_command(platform: str) -> str:
    return (
        ...
        "'import spyder_e_remote_services as sprs; print(sprs.__version__)'"
    )
