...
# Local imports
from spyder_e.plugins.remoteclient.plugin import RemoteClient
from spyder_e.plugins.remoteclient.tests.conftest import (
    await_future,
    run_async,
    mark_remote_test,
)
...
class TestVersionCheck:
    def test_wrong_version(
        ...
        monkeypatch.setattr(
            "spyder_e.plugins.remoteclient.api.manager.ssh.SPYDER_REMOTE_MAX_VERSION",
            "0.0.1",
        )
        monkeypatch.setattr(
            "spyder_e.plugins.remoteclient.api.manager.jupyterhub.SPYDER_REMOTE_MAX_VERSION",
            "0.0.1",
        )
        monkeypatch.setattr(
            "spyder_e.plugins.remoteclient.widgets.container.SPYDER_REMOTE_MAX_VERSION",
            "0.0.1",
        )
        ...
        monkeypatch.setattr(
            "spyder_e.plugins.remoteclient.widgets.container.QMessageBox.critical",
            mock_critical,
        )
