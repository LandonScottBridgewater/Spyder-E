...
from spyder_e.config.manager import CONF, NoDefault
from spyder_e.plugins.shortcuts.utils import ShortcutData
...
from spyder_e.utils.stringmatching import get_search_regex, get_search_scores
from spyder_e.widgets.helperwidgets import (
    ClearLineEdit,
    HTMLDelegate,
    HoverRowsTableView,
    VALID_FINDER_CHARS,
