...
from spyder_e.plugins.shortcuts.confpage import ShortcutsConfigPage
from spyder_e.plugins.shortcuts.utils import (
    ShortcutData,
    SHORTCUTS_FOR_WIDGETS_DATA,
)
from spyder_e.plugins.shortcuts.widgets.summary import ShortcutsSummaryDialog
from spyder_e.utils.qthelpers import add_shortcut_to_tooltip, SpyderAction
