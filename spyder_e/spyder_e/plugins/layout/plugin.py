...
from spyder_e.api.plugins import (
...
from spyder_e.plugins.mainmenu.api import ApplicationMenus, WindowMenuSections
from spyder_e.plugins.layout.container import (
...
from spyder_e.plugins.preferences.api import PreferencesActions
from spyder_e.plugins.toolbar.api import (
...
class Layout(SpyderPluginV2, SpyderShortcutsMixin):
    ...
    def register_layout(self, parent_plugin, layout_type):
        ...
        Parameters
        ----------
        parent_plugin: spyder_e.api.plugins.SpyderPluginV2
            Plugin registering the layout type.
        layout_type: spyder_e.plugins.layout.api.BaseGridLayoutType
            Layout to register.
        """
    ...
    def get_layout(self, layout_id):
        ...
        Returns
        -------
        Instance of a spyder_e.plugins.layout.api.BaseGridLayoutType subclass
            Layout.
        """
