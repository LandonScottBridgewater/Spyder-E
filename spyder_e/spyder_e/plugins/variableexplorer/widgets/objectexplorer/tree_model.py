...
from spyder_e.plugins.variableexplorer.widgets.objectexplorer.utils import (
    cut_off_str)
from spyder_e.plugins.variableexplorer.widgets.objectexplorer.tree_item import (
    TreeItem)
