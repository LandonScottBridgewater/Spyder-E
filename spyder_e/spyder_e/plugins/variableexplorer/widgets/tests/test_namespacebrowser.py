...
from spyder_e.plugins.variableexplorer.widgets.namespacebrowser import (
    NamespaceBrowser)
from spyder_e.widgets.collectionseditor import ROWS_TO_LOAD
from spyder_e.widgets.tests.test_collectioneditor import data, data_table
...
def test_namespacebrowser_plot_with_mute_inline_plotting_true(
    ...
    with patch('spyder_e.pyplot.figure', return_value=mock_figure), \
...
def test_namespacebrowser_plot_with_mute_inline_plotting_false(namespacebrowser):
    ...
    with patch('spyder_e.pyplot.figure') as mock_figure:
        namespacebrowser.plot(mock_plot_function)
