...
from spyder_e.utils.test import close_message_box
from spyder_e.plugins.variableexplorer.widgets import dataframeeditor
...
def test_dataframeeditor_refresh_after_edit(result):
    ...
    with patch('spyder_e.plugins.variableexplorer.widgets.dataframeeditor'
...
def test_change_format(qtbot):
    ...
    with patch(
        'spyder_e.plugins.variableexplorer.widgets.dataframeeditor'
...
def test_dataframeeditor_menu_options(qtbot, monkeypatch):
    ...
    attr_to_patch = ('spyder_e.plugins.variableexplorer.widgets' +
