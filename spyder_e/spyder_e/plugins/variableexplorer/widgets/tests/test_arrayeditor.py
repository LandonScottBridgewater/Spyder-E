...
# Local imports
from spyder_e.plugins.variableexplorer.widgets.arrayeditor import (
...
def test_arrayeditor_refresh_after_edit(result):
    ...
    with patch('spyder_e.plugins.variableexplorer.widgets.arrayeditor'
...
def test_arraymodel_set_data_overflow(monkeypatch):
    ...
    attr_to_patch = 'spyder_e.plugins.variableexplorer.widgets.arrayeditor.QMessageBox'
