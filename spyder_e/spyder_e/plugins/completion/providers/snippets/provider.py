...
from spyder_e.config.snippets import SNIPPETS
from spyder_e.plugins.completion.api import (SpyderCompletionProvider,
                                           SUPPORTED_LANGUAGES)
from spyder_e.plugins.completion.providers.snippets.actor import SnippetsActor
from spyder_e.plugins.completion.providers.snippets.conftabs import (
    SnippetsConfigTab
)
