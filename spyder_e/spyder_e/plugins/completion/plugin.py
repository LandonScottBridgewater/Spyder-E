...
# Local imports
from spyder_e.api.plugins import SpyderPluginV2, Plugins
...
from spyder_e.plugins.completion.api import (CompletionRequestTypes,
                                           SpyderCompletionProvider,
                                           COMPLETION_ENTRYPOINT)
from spyder_e.plugins.completion.confpage import CompletionConfigPage
from spyder_e.plugins.completion.container import CompletionContainer
...
class CompletionPlugin(SpyderPluginV2):
    ...
    completion_capabilites: dict
        ...
        to `spyder_e.plugins.completion.api.SERVER_CAPABILITES`.
    language: str
    ...
    def gather_create_ops(self):
        ...
        :class:`spyder_e.api.preferences.PluginConfigPage` class
        """
    ...
    def send_request(self, language: str, req_type: str, req: dict):
        ...
        req_type: str
            ...
            :class:`spyder_e.plugins.completion.api.CompletionRequestTypes`
        req: dict
            Request body
            {
                'filename': str,
    ...
    def project_path_update(self, project_path: str, update_kind='addition',
        ...
        update_kind: str
            ...
            :class:`spyder_e.plugins.completion.WorkspaceUpdateKind`.
        instance: object
            Reference to :class:`spyder_e.plugins.projects.plugin.Projects`.
        """
        for provider_name in self.providers:
            provider_info = self.providers[provider_name]
            if provider_info['status'] == self.RUNNING:
