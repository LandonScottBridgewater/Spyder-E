...
COMPLETION_ENTRYPOINT = 'spyder_e.completions'

# -------------- SPYDER COMPLETION PROVIDER INTERFACE ---------------

class CompletionConfigurationObserver(SpyderConfigurationObserver):
    """
    Extension to the :class:`spyder_e.api.config.mixins.SpyderConfigurationObserver`
...
class SpyderCompletionProvider(QObject, CompletionConfigurationObserver):
    ...
    # :class:`spyder_e.api.widgets.status.StatusBarWidget` or
    ...
    def __init__(self, parent, config):
        ...
        Parameters
        ----------
        parent: spyder_e.plugins.completion.plugin.CompletionPlugin
    ...
    def broadcast_notification(
        ...
        notification_type: str
            Type of request, one of
            :class:`spyder_e.plugins.completion.CompletionTypes`
        notification: dict
            Notification body
            {
    ...
    def project_path_update(self, project_path: str, update_kind: str,
        ...
        update_kind: str
            ...
            :class:`spyder_e.plugins.completion.api.WorkspaceUpdateKind`
        instance: object
