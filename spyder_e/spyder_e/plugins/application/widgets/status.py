...
from spyder_e.api.widgets.status import BaseTimerStatus
...
from spyder_e.utils.stylesheet import WIN
...
class InAppAppealDialog(QDialog, SpyderFontsMixin):
    ...
    def __init__(self, parent=None):
        ...
        appeal_page_path = osp.join(
            get_module_source_path("spyder_e.plugins.application.widgets"),
            "appeal_page",
            "dark" if is_dark_interface() else "light",
            "index.html",
        )

        from spyder_e.widgets.browser import WebView
