...
# Local imports
from spyder_e.plugins.statusbar.widgets.tests.test_status import status_bar  # noqa
from spyder_e.plugins.application.widgets.status import InAppAppealStatus
