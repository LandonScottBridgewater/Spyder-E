...
def test_open_file_action(application_plugin):
    ...
    with patch('spyder_e.plugins.application.container.QFileDialog', mock_QFileDialog):
        with patch('spyder_e.plugins.application.plugin.PLUGIN_REGISTRY', mock_registry):
            container = application_plugin.get_container()
