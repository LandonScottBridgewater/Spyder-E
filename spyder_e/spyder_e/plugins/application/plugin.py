...
from spyder_e.api.widgets.menus import SpyderMenu, MENU_SEPARATOR
from spyder_e.app import SHORTCUT_EXE
from spyder_e.config.base import (get_module_path, get_debug_level,
                                running_under_pytest)
from spyder_e.plugins.application.confpage import ApplicationConfigPage
from spyder_e.plugins.application.container import (
    ApplicationActions, ApplicationContainer, ApplicationPluginMenus)
from spyder_e.plugins.console.api import ConsoleActions
...
from spyder_e.utils.qthelpers import add_actions
...
class Application(SpyderPluginV2):
    ...
    def get_application_context_menu(self, parent=None):
        ...
        # Help actions
        if help_plugin:
            from spyder_e.plugins.help.plugin import HelpActions
            tutorial_action = help_plugin.get_action(
                HelpActions.ShowSpyderTutorialAction)
            actions += [tutorial_action]
        # Shortcuts actions
        if shortcuts:
            from spyder_e.plugins.shortcuts.plugin import ShortcutActions
    ...
    def restart(self, reset=False, close_immediately=False):
        ...
        spyder_start_directory = get_module_path('spyder_e')
