...
# Local imports
from spyder_e.config.base import running_in_ci, running_in_ci_with_conda
from spyder_e.config.gui import get_color_scheme
from spyder_e.plugins.help.tests.test_plugin import check_text
from spyder_e.plugins.ipythonconsole.tests.conftest import (
...
def test_wrong_std_module(ipyconsole, qtbot, tmpdir, spyder_pythonpath):
    ...
    # Assert the extra path from spyder_e_pythonpath was added
    if spyder_pythonpath:
        check_sys_path = (
...
def test_restart_interactive_backend(ipyconsole, qtbot):
    ...
    # running tests on CI.
    # See `spyder_e.plugins.ipythonconsole.widgets.status.MatplotlibStatus.on_kernel_start`
