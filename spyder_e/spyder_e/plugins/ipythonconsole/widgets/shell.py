...
from spyder_e.config.base import is_conda_based_app, running_under_pytest
from spyder_e.config.gui import get_color_scheme, is_dark_interface
...
if typing.TYPE_CHECKING:
    from spyder_e.plugins.ipythonconsole.widgets.client import ClientWidget
