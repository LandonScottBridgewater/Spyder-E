...
from spyder_e.plugins.ipythonconsole.confpage import IPythonConsoleConfigPage
from spyder_e.plugins.ipythonconsole.widgets.run_conf import IPythonConfigOptions
from spyder_e.plugins.ipythonconsole.widgets.main_widget import (
...
from spyder_e.plugins.editor.api.run import CellRun, FileRun, SelectionRun
...
class IPythonConsole(SpyderDockablePlugin, RunExecutor):
    ...
    def rename_client_tab(self, client, given_name):
        ...
        Parameters
        ----------
        client: spyder_e.plugins.ipythonconsole.widgets.client.ClientWidget
            Client to rename.
        given_name: str
