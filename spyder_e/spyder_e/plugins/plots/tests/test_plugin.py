...
from spyder_e.plugins.plots.plugin import Plots
from spyder_e.plugins.plots.widgets.main_widget import PlotsWidgetActions
from spyder_e.plugins.plots.widgets.tests.test_plots_widgets import (
