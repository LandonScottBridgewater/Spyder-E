...
from spyder_e.config.base import running_in_ci, running_under_pytest
...
from spyder_e.widgets.collapsible import CollapsibleWidget
from spyder_e.widgets.helperwidgets import TipWidget
