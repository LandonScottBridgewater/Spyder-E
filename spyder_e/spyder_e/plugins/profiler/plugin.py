...
from spyder_e.plugins.mainmenu.api import ApplicationMenus, RunMenuSections
from spyder_e.plugins.profiler.confpage import ProfilerConfigPage
from spyder_e.plugins.profiler.widgets.main_widget import ProfilerWidget
