...
from spyder_e.config.base import DEV
from spyder_e.plugins.toolbar.api import ApplicationToolbars
from spyder_e.utils.qthelpers import SpyderAction
...
class ToolbarContainer(PluginMainContainer):
    ...
    def create_application_toolbar(
        ...
        Returns
        -------
        spyder_e.api.widgets.toolbar.ApplicationToolbar
    ...
    def add_application_toolbar(self, toolbar, mainwindow=None):
        ...
        Parameters
        ----------
        toolbar: spyder_e.api.widgets.toolbars.ApplicationToolbar
    ...
    def get_application_toolbar(self, toolbar_id: str) -> ApplicationToolbar:
        ...
        Returns
        -------
        spyder_e.api.widgets.toolbars.ApplicationToolbar
