...
from spyder_e.plugins.updatemanager import workers
from spyder_e.plugins.updatemanager.workers import (
    UpdateType, get_asset_info, WorkerUpdate
)
from spyder_e.plugins.updatemanager.widgets import update
from spyder_e.plugins.updatemanager.widgets.update import UpdateManagerWidget
...
def capture_logging(caplog):
    # Capture >=DEBUG logging messages for spyder_e.plugins.updatemanager.
    # Messages will be reported at the end of the pytest run for failed tests.
    caplog.set_level(10, "spyder_e.plugins.updatemanager")
