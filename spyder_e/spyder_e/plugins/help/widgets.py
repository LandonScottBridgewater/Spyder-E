...
from spyder_e.api.widgets.comboboxes import SpyderComboBox
from spyder_e.api.widgets.main_widget import PluginMainWidget
from spyder_e.api.widgets.mixins import SpyderWidgetMixin
from spyder_e.config.base import get_module_source_path
from spyder_e.plugins.help.utils.sphinxify import (CSS_PATH, generate_context,
                                                 loading, usage, warning)
from spyder_e.plugins.help.utils.sphinxthread import SphinxThread
from spyder_e.utils import programs
from spyder_e.utils.image_path_manager import get_image_path
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.qthelpers import start_file
from spyder_e.widgets.comboboxes import EditableComboBox
...
class HelpWidget(PluginMainWidget):
    ...
    def show_tutorial(self):
        ...
        tutorial_path = get_module_source_path('spyder_e.plugins.help.utils')
    ...
    def set_object_text(self, text, force_refresh=False, ignore_unknown=False):
        ...
        See Also
        --------
        :py:meth:spyder_e.widgets.mixins.GetHelpMixin.show_object_info
        """
    ...
    def set_internal_console(self, console):
        ...
        Parameters
        ----------
        console: :py:class:spyder_e.plugins.console.plugin.Console
            Console plugin.
        """
