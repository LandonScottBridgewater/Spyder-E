...
from spyder_e.config.base import get_module_data_path, get_module_source_path
...
CONFDIR_PATH = get_module_source_path('spyder_e.plugins.help.utils')
...
MATHJAX_PATH = get_module_data_path('spyder_e',
                                    relpath=osp.join('utils', 'help',
                                                     JS_PATH, 'mathjax'),
                                    attr_name='MATHJAXPATH')

JQUERY_PATH = get_module_data_path('spyder_e',
                                   relpath=osp.join('utils', 'help',
                                                    JS_PATH),
...
def sphinxify(docstring, context, buildername='html'):
    ...
    confdir = osp.join(get_module_source_path('spyder_e.plugins.help.utils'))
    srcdir = mkdtemp()
...
def generate_configuration(directory):
    ...
    conf = osp.join(get_module_source_path('spyder_e.plugins.help.utils'),
                    'conf.py')
