...
# Local imports
from spyder_e.plugins.explorer.widgets.main_widget import FileExplorerTest
from spyder_e.plugins.projects.widgets.main_widget import ProjectExplorerTest
