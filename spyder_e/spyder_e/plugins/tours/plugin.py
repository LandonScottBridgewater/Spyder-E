...
from spyder_e.config.base import get_safe_mode, running_under_pytest
from spyder_e.plugins.application.api import ApplicationActions
from spyder_e.plugins.mainmenu.api import ApplicationMenus, HelpMenuSections
from spyder_e.plugins.tours.container import TourActions, ToursContainer
from spyder_e.plugins.tours.tours import INTRO_TOUR, TourIdentifiers
from spyder_e.plugins.tours.api import SpyderWidgets
...
class Tours(SpyderPluginV2):
    ...
    def register_tour(self, tour_id, title, tour_data):
        """
        Register a new interactive tour on spyder_e.
