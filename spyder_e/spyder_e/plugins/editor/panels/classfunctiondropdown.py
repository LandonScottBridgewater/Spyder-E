...
from spyder_e.api.widgets.comboboxes import SpyderComboBoxWithIcons
from spyder_e.plugins.completion.api import SymbolKind
...
class ClassFunctionDropdown(Panel):
    ...
    Parameters
    ----------
    editor : :class:`spyder_e.plugins.editor.widgets.codeeditor.CodeEditor`
    ...
    def populate(self, combobox, data, add_parents=False):
        ...
        Parameters
        ----------
        combobox : :class:`spyder_e.api.widgets.comboboxes.SpyderComboBox`
