...
from spyder_e.plugins.editor.panels.utils import FoldingRegion
from spyder_e.plugins.editor.utils.editor import (TextHelper, DelayJobRunner,
                                                drift_color)
from spyder_e.utils.icon_manager import ima
from spyder_e.widgets.mixins import EOL_SYMBOLS
...
class FoldingPanel(Panel):
    ...
    def _highlight_caret_scope(self):
        ...
        spyder_e.widgets.panels.FoldingPanel.highlight_care_scope` is True.
        """
        cursor = self.editor.textCursor()
