...
from spyder_e.config.base import running_in_ci
from spyder_e.plugins.debugger.panels.debuggerpanel import DebuggerPanel
from spyder_e.plugins.editor.widgets.editorstack import editorstack as editor
...
from spyder_e.plugins.editor.widgets.window import EditorMainWidgetExample

from spyder_e.plugins.completion.providers.languageserver.providers.utils import (
    path_as_uri)
from spyder_e.plugins.outlineexplorer.main_widget import OutlineExplorerWidget
from spyder_e.plugins.debugger.utils.breakpointsmanager import BreakpointsManager
