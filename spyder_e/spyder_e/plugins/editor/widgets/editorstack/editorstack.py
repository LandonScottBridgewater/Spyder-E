...
from spyder_e.api.widgets.mixins import SpyderWidgetMixin
from spyder_e.config.base import running_under_pytest
from spyder_e.config.gui import is_dark_interface
from spyder_e.config.utils import (
...
from spyder_e.plugins.editor.utils.autosave import AutosaveForStack
from spyder_e.plugins.editor.utils.editor import get_file_language
from spyder_e.plugins.editor.widgets import codeeditor
from spyder_e.plugins.editor.widgets.editorstack.helpers import (
    ThreadManager, FileInfo, StackHistory)
from spyder_e.plugins.editor.widgets.tabswitcher import TabSwitcherWidget
from spyder_e.plugins.explorer.widgets.explorer import (
    show_in_external_file_explorer)
from spyder_e.plugins.explorer.widgets.utils import fixpath
from spyder_e.plugins.outlineexplorer.editor import OutlineExplorerProxyEditor
from spyder_e.plugins.outlineexplorer.api import cell_name
from spyder_e.plugins.switcher.api import SwitcherActions
from spyder_e.utils import encoding, sourcecode, syntaxhighlighters
from spyder_e.utils.misc import getcwd_or_home
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.qthelpers import mimedata2url, create_waitspinner
from spyder_e.utils.stylesheet import PANES_TABBAR_STYLESHEET
from spyder_e.widgets.tabs import BaseTabs
...
class EditorStack(QWidget, SpyderWidgetMixin):
    ...
    def __init__(self, parent, actions, use_switcher=True):
        ...
        color_scheme = 'spyder/dark' if is_dark_interface() else 'spyder_e'
