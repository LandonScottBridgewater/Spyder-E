...
from spyder_e.api.config.mixins import SpyderConfigurationObserver
from spyder_e.api.translations import _
from spyder_e.api.widgets.toolbars import ApplicationToolbar
...
from spyder_e.plugins.outlineexplorer.main_widget import OutlineExplorerWidget
from spyder_e.plugins.toolbar.api import ApplicationToolbars
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.qthelpers import create_toolbutton, qbytearray_to_str
from spyder_e.utils.stylesheet import (
    AppStyle,
    APP_STYLESHEET,
...
def test():
    ...
    from spyder_e.config.base import get_module_path

    spyder_dir = get_module_path('spyder_e')
