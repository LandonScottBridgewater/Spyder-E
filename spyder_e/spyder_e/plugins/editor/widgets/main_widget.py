...
# Local imports
from spyder_e.api.config.decorators import on_conf_change
from spyder_e.api.translations import _
from spyder_e.api.widgets.main_widget import PluginMainWidget
from spyder_e.config.base import get_conf_path
from spyder_e.plugins.editor.api.panel import Panel
from spyder_e.utils import encoding, programs, sourcecode
from spyder_e.utils.qthelpers import create_action, qbytearray_to_str
from spyder_e.utils.misc import getcwd_or_home
from spyder_e.widgets.findreplace import FindReplace
from spyder_e.plugins.application.api import ApplicationActions
from spyder_e.plugins.editor.api.actions import EditorWidgetActions
from spyder_e.plugins.editor.api.run import (
    EditorRunConfiguration, FileRun, SelectionRun, CellRun,
    SelectionContextModificator, ExtraAction)
from spyder_e.plugins.editor.utils.autosave import AutosaveForPlugin
from spyder_e.plugins.editor.utils.editor import get_default_file_content
from spyder_e.plugins.editor.utils.switcher_manager import EditorSwitcherManager
from spyder_e.plugins.editor.widgets.codeeditor import CodeEditor
from spyder_e.plugins.editor.widgets.editorstack import EditorStack
from spyder_e.plugins.editor.widgets.splitter import EditorSplitter
from spyder_e.plugins.editor.widgets.window import EditorMainWindow
from spyder_e.plugins.editor.utils.bookmarks import (load_bookmarks,
                                                   update_bookmarks)
from spyder_e.plugins.editor.widgets.status import (CursorPositionStatus,
...
from spyder_e.widgets.printer import SpyderPrinter, SpyderPrintPreviewDialog
from spyder_e.widgets.simplecodeeditor import SimpleCodeEditor
...
class EditorMainWidget(PluginMainWidget):
    ...
    See Also
    --------
    :py:meth:spyder_e.plugins.editor.widgets.editorstack.EditorStack.send_to_help
    """
    ...
    Parameters
    ----------
    codeeditor: spyder_e.plugins.editor.widgets.codeeditor.CodeEditor
        The codeeditor.
    """
            ...
            if self.untitled_num == 0:
                for finfo in current_es.data:
                    ...
                    if _("untitled") in current_filename:
                        ...
                        # spyder_e. Please see spyder-ide/spyder#7831
