...
from spyder_e.plugins.editor.panels.linenumber import LineNumberArea
from spyder_e.plugins.editor.panels.edgeline import EdgeLine
from spyder_e.plugins.editor.panels.scrollflag import ScrollFlagArea
from spyder_e.plugins.editor.panels.indentationguides import IndentationGuide
