...
from spyder_e.plugins.preferences.tests.conftest import config_dialog
from spyder_e.plugins.shortcuts.plugin import Shortcuts
from spyder_e.widgets.mixins import TIP_PARAMETER_HIGHLIGHT_COLOR
