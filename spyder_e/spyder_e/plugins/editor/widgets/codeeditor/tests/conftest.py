...
from spyder_e.plugins.completion.tests.conftest import (
...
from spyder_e.plugins.explorer.widgets.tests.conftest import create_folders_files
...
from spyder_e.utils.programs import is_module_installed
