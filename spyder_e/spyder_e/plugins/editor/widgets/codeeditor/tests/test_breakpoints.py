...
# Local imports
from spyder_e import version_info
import spyder_e.plugins.editor.widgets.codeeditor as codeeditor
from spyder_e.plugins.debugger.utils import breakpointsmanager
