...
# TODO: Try to separate this module from spyder_e to create a self
...
from spyder_e.config.base import running_under_pytest
from spyder_e.plugins.editor.api.decoration import TextDecoration
from spyder_e.plugins.editor.api.panel import Panel
from spyder_e.plugins.editor.extensions import (CloseBracketsExtension,
                                              CloseQuotesExtension,
                                              DocstringWriterExtension,
                                              QMenuOnlyForEnter,
                                              EditorExtensionsManager,
                                              SnippetsExtension)
from spyder_e.plugins.editor.panels import (
    ClassFunctionDropdown, EdgeLine, FoldingPanel, IndentationGuide,
    LineNumberArea, PanelsManager, ScrollFlagArea)
from spyder_e.plugins.editor.utils.editor import (TextHelper, BlockUserData,
                                                get_file_language)
from spyder_e.plugins.editor.utils.kill_ring import QtKillRing
from spyder_e.plugins.editor.utils.languages import ALL_LANGUAGES, CELL_LANGUAGES
from spyder_e.plugins.editor.widgets.gotoline import GoToLineDialog
from spyder_e.plugins.editor.widgets.base import TextEditBaseWidget
from spyder_e.plugins.editor.widgets.codeeditor.lsp_mixin import LSPMixin
from spyder_e.plugins.editor.widgets.codeeditor.multicursor_mixin import (
    MultiCursorMixin
)
from spyder_e.plugins.outlineexplorer.api import (OutlineExplorerData as OED,
                                                is_cell_header)
from spyder_e.utils import encoding, sourcecode
from spyder_e.utils.clipboard_helper import CLIPBOARD_HELPER
from spyder_e.utils.icon_manager import ima
from spyder_e.utils import syntaxhighlighters as sh
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.qthelpers import file_uri, mimedata2url, start_file
from spyder_e.utils.vcs import get_git_remotes, remote_to_url
from spyder_e.utils.qstringhelpers import qstring_length
from spyder_e.widgets.mixins import HINT_MAX_WIDTH
...
class CodeEditor(LSPMixin, TextEditBaseWidget, MultiCursorMixin):
    ...
    def panels(self):
        ...
        :class:`spyder_e.widgets.panels.managers.PanelsManager`
...
class TestWidget(QSplitter):
    def __init__(self, parent):
        ...
        self.setWindowIcon(ima.icon('spyder_e'))
...
def test(fname):
    from spyder_e.utils.qthelpers import qapplication
