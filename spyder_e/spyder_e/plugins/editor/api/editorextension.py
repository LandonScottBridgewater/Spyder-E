...
class EditorExtension(object):
    ...
    :meth:`spyder_e.plugins.editor.widgets.codeeditor.CodeEditor.panels.append`.

    Subclasses may/should override the following methods:

        - :meth:`spyder_e.api.EditorExtension.on_install`
        - :meth:`spyder_e.api.EditorExtension.on_uninstall`
        - :meth:`spyder_e.api.EditorExtension.on_state_changed`
    ...
    def editor(self):
        ...
        **READ ONLY**
        ...
        :rtype: spyder_e.plugins.editor.widgets.codeeditor.CodeEditor
        """
        return self._editor
    ...
    def enabled(self):
        ...
        :meth:`spyder_e.api.EditorExtension.on_state_changed` will be called as
    ...
    def __init__(self):
        ...
        :class:`spyder_e.widgets.sourcecode.CodeEditor` uses that as the
    ...
    def on_install(self, editor):
        ...
        :type editor: spyder_e.plugins.editor.widgets.codeeditor.CodeEditor
