...
from spyder_e.plugins.editor.widgets.editorstack import editorstack as editor_module
from spyder_e.plugins.editor.widgets.codeeditor import CodeEditor
from spyder_e.plugins.run.api import RunContext
from spyder_e.utils.sourcecode import get_eol_chars, get_eol_chars_from_os_name
