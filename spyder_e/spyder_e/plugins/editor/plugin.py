...
from spyder_e.api.fonts import SpyderFontType
from spyder_e.api.plugins import SpyderDockablePlugin, Plugins
from spyder_e.api.plugin_registration.decorators import (
    on_plugin_available,
    on_plugin_teardown,
)
...
from spyder_e.plugins.editor.confpage import EditorConfigPage
from spyder_e.plugins.editor.widgets.main_widget import EditorMainWidget
from spyder_e.plugins.mainmenu.api import (
    ApplicationMenus,
    EditMenuSections,
    FileMenuSections,
    SearchMenuSections,
...
from spyder_e.plugins.run.api import RunContext
...
class Editor(SpyderDockablePlugin):
    ...
    def get_codeeditor_for_filename(self, filename):
        ...
        Returns
        -------
        spyder_e.plugins.editor.codeeditor.CodeEditor
    ...
    def load(self, *args, **kwargs):
        ...
        editorwindow: Optional[spyder_e.plugins.editor.widgets.window.EditorMainWindow]  # noqa
    ...
    def load_edit(self, filename):
        ...
        Used by `spyder_e.plugins.outlineexplorer.plugin.[on_editor_available|on_editor_teardown]`  # noqa
    ...
    def new(self, *args, **kwargs):
        ...
        editorstack: Optional[spyder_e.plugins.editor.widgets.editorstack.EditorStack]  # noqa
    ...
    def add_supported_run_configuration(self, *args, **kwargs):
        ...
        Parameters
        ----------
        config : spyder_e.plugins.editor.api.run.EditorRunConfiguration
    ...
    def get_current_editorstack(self):
        ...
        Returns
        -------
        spyder_e.plugins.editor.editorstack.EditorStack
