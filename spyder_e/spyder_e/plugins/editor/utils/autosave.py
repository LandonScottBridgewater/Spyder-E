...
from spyder_e.plugins.editor.widgets.autosaveerror import AutosaveErrorDialog
from spyder_e.plugins.editor.widgets.recover import RecoveryDialog
from spyder_e.utils.programs import is_spyder_process
