...
from spyder_e.plugins.findinfiles.widgets.main_widget import FindInFilesWidget
...
def searchin_combobox(qtbot, request):
    ...
    from spyder_e.plugins.findinfiles.widgets import combobox
...
def test_add_external_paths(searchin_combobox, mocker):
    ...
    mocker.patch(
        'spyder_e.plugins.findinfiles.widgets.combobox.getexistingdirectory',
