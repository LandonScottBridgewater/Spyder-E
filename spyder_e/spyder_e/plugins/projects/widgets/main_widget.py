...
from spyder_e.config.utils import EDIT_EXTENSIONS
from spyder_e.plugins.completion.api import (
    CompletionRequestTypes, FileChangeType)
from spyder_e.plugins.completion.decorators import (
    class_register, handles, request)
from spyder_e.plugins.explorer.api import DirViewActions
from spyder_e.plugins.projects.api import (
    BaseProjectType, EmptyProject, WORKSPACE)
from spyder_e.plugins.projects.utils.watcher import WorkspaceWatcher
from spyder_e.plugins.projects.widgets.projectdialog import (
    is_writable,
    ProjectDialog,
)
from spyder_e.plugins.projects.widgets.projectexplorer import (
    ProjectExplorerTreeWidget)
from spyder_e.plugins.switcher.utils import get_file_icon, shorten_paths
from spyder_e.utils import encoding
from spyder_e.utils.misc import getcwd_or_home
from spyder_e.utils.programs import find_program
from spyder_e.utils.workers import WorkerManager
...
class ProjectExplorerWidget(PluginMainWidget):
    ...
    def register_project_type(self, parent_plugin, project_type):
        ...
        Parameters
        ----------
        parent_plugin: spyder_e.plugins.api.plugins.SpyderPluginV2
            The parent plugin instance making the project type registration.
        project_type: spyder_e.plugins.projects.api.BaseProjectType
    ...
    def _load_project_type_class(self, path):
        ...
        Returns
        -------
        spyder_e.plugins.projects.api.BaseProjectType
