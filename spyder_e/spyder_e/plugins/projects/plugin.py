...
from spyder_e.plugins.completion.api import WorkspaceUpdateKind
from spyder_e.plugins.mainmenu.api import ApplicationMenus, ProjectsMenuSections
from spyder_e.plugins.projects.api import EmptyProject
from spyder_e.plugins.projects.widgets.main_widget import (
...
class Projects(SpyderDockablePlugin):
    ...
    def open_project(self, path=None, project_type=None, restart_console=True,
        ...
        project_type: spyder_e.plugins.projects.api.BaseProjectType, optional
            Project type class.
