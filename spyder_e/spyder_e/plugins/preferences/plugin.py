...
# Local imports
from spyder_e.api.plugins import Plugins, SpyderPluginV2
from spyder_e.api.plugin_registration.decorators import (
    on_plugin_available, on_plugin_teardown)
from spyder_e.api.plugin_registration.registry import PreferencesAdapter
from spyder_e.api.translations import _
from spyder_e.config.base import running_under_pytest
from spyder_e.config.main import CONF_VERSION
from spyder_e.config.user import NoDefault
from spyder_e.plugins.mainmenu.api import ApplicationMenus, ToolsMenuSections
from spyder_e.plugins.preferences import MOST_IMPORTANT_PAGES
from spyder_e.plugins.preferences.widgets.container import (
    PreferencesActions, PreferencesContainer)
from spyder_e.plugins.pythonpath.api import PythonpathActions
from spyder_e.plugins.toolbar.api import ApplicationToolbars, MainToolbarSections
