...
from spyder_e.utils.svg_colorizer import SVGColorize
...
class IconManager():
    ...
    def __init__(self):
        ...
        self._qtaargs = {
            ...
            'python':                  [('spyder_e.python-logo-up', 'spyder_e.python-logo-down'), {'options': [{'color': SpyderPalette.PYTHON_LOGO_UP}, {'color': SpyderPalette.PYTHON_LOGO_DOWN}]}],
            'pythonpath':              [('spyder_e.python-logo-up', 'spyder_e.python-logo-down'), {'options': [{'color': SpyderPalette.PYTHON_LOGO_UP}, {'color': SpyderPalette.PYTHON_LOGO_DOWN}]}],
            ...
            'spyder_e':                  [('spyder_e.spyder-logo-background', 'spyder_e.spyder-logo-web', 'spyder_e.spyder-logo-snake'),  {'options': [{'color': SpyderPalette.SPYDER_LOGO_BACKGROUND}, {'color': SpyderPalette.SPYDER_LOGO_WEB}, {'color': SpyderPalette.SPYDER_LOGO_SNAKE}]}],
            ...
            # --- Other ------------------------------------------------
            'spyder_e.example':          [('mdi.eye',), {'color': self.MAIN_FG_COLOR}],
            'spyder_e.line_profiler':    [('mdi.eye',), {'color': self.MAIN_FG_COLOR}],
        ...
        if theme == 'spyder 3':
            try:
                ...
                if not self._resource['loaded']:
                    qta.load_font('spyder_e', 'spyder_e.ttf', 'spyder-charmap.json',
