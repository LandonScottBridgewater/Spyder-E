...
from spyder_e.utils.vcs import (ActionToolNotFound, get_git_refs,
...
@pytest.mark.parametrize(
    ...
    [
        ('https://github.com/neophnx/spyder_e.git',
         'https://github.com/neophnx/spyder'),
        ('http://github.com/neophnx/spyder_e.git',
         'http://github.com/neophnx/spyder'),
        ('git@github.com:goanpeca/spyder_e.git',
