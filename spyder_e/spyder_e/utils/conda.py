...
# Local imports
from spyder_e.utils.programs import find_program, run_program, run_shell_command
...
def get_spyder_conda_channel():
    ...
    cmdstr = ' '.join([conda, 'list', 'spyder_e', '--json', '--prefix', env])
