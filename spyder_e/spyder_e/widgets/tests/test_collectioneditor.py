...
from spyder_e.widgets.collectionseditor import (
...
from spyder_e.plugins.variableexplorer.widgets.tests.test_dataframeeditor import (
...
def test_shows_dataframeeditor_when_editing_index(monkeypatch):
    for __, rng in generate_pandas_indexes().items():
        ...
        attr_to_patch_dfedit = ('spyder_e.plugins.variableexplorer.widgets.' +
...
def test_shows_collectioneditor_when_editing_frozenset():
    ...
    name_to_patch = 'spyder_e.widgets.collectionseditor.CollectionsEditor'
...
def test_collectioneditor_refresh_after_edit(result):
    ...
    with patch('spyder_e.widgets.collectionseditor.QMessageBox.question',
...
def test_collectioneditor_refresh_when_variable_deleted(qtbot):
    ...
    editor.setup(lst)
    with patch('spyder_e.widgets.collectionseditor.QMessageBox'
...
def test_edit_mutable_and_immutable_types(monkeypatch):
    ...
    """
    MockQLineEdit = Mock()
    attr_to_patch_qlineedit = ('spyder_e.plugins.variableexplorer.widgets.' +
                               'collectionsdelegate.QLineEdit')
    monkeypatch.setattr(attr_to_patch_qlineedit, MockQLineEdit)

    MockTextEditor = Mock()
    attr_to_patch_textedit = ('spyder_e.plugins.variableexplorer.widgets.' +
                              'collectionsdelegate.TextEditor')
    monkeypatch.setattr(attr_to_patch_textedit, MockTextEditor)

    MockQDateTimeEdit = Mock()
    attr_to_patch_qdatetimeedit = ('spyder_e.plugins.variableexplorer.widgets.' +
    ...
    attr_to_patch_coledit = ('spyder_e.widgets.' +
...
def test_edit_large_int(monkeypatch, exponent, error_expected):
    ...
    with patch(
        'spyder_e.plugins.variableexplorer.widgets'
        '.collectionsdelegate.QLineEdit'
    ) as MockQLineEdit:
        with patch(
            'spyder_e.plugins.variableexplorer.widgets'
...
def test_editor_parent_set(monkeypatch):
    ...
    attr_to_patch_arredit = ('spyder_e.plugins.variableexplorer.widgets.' +
    ...
    attr_to_patch_objectexplorer = ('spyder_e.plugins.variableexplorer.widgets.'
