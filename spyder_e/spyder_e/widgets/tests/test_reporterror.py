...
# Local imports
from spyder_e import __project_url__
from spyder_e.widgets.reporterror import (DESC_MIN_CHARS, TITLE_MIN_CHARS,
                                        SpyderErrorDialog)
...
def test_report_issue_url(monkeypatch):
    ...
    attr_to_patch = ('spyder_e.widgets.reporterror.QDesktopServices')
