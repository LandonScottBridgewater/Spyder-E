...
# Local imports
from spyder_e.api.fonts import SpyderFontsMixin, SpyderFontType
...
from spyder_e.utils.qthelpers import mimedata2url
from spyder_e.utils.stringmatching import get_search_scores, get_search_regex
from spyder_e.plugins.variableexplorer.widgets.collectionsdelegate import (
    CollectionsDelegate,
    SELECT_ROW_BUTTON_SIZE,
)
from spyder_e.plugins.variableexplorer.widgets.importwizard import ImportWizard
from spyder_e.widgets.emptymessage import EmptyMessageWidget
from spyder_e.widgets.helperwidgets import CustomSortFilterProxy, MessageCheckBox
from spyder_e.plugins.variableexplorer.widgets.basedialog import BaseDialog
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.stylesheet import AppStyle, MAC
...
class CollectionsEditorTableView(BaseTableView):
    ...
    def oedit(self, key):
        """Edit item"""
        data = self.source_model.get_data()
        from spyder_e.plugins.variableexplorer.widgets.objecteditor import (
            oedit)
        oedit(data[key])
