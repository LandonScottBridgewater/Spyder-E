...
from spyder_e.config.base import CHECK_ALL, EXCLUDED_NAMES
from spyder_e.config.utils import IMPORT_EXT
from spyder_e.config.appearance import APPEARANCE
from spyder_e.plugins.editor.utils.findtasks import TASKS_PATTERN
