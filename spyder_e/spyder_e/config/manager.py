...
from spyder_e.config.main import CONF_VERSION, DEFAULTS, NAME_MAP
from spyder_e.config.types import ConfigurationKey, ConfigurationObserver
from spyder_e.config.user import UserConfig, MultiUserConfig, NoDefault, cp
from spyder_e.plugins.shortcuts.utils import SHORTCUTS_FOR_WIDGETS_DATA
from spyder_e.utils.programs import check_version
...
class ConfigurationManager(object):
    ...
    def __init__(self, parent=None, active_project_callback=None,
        ...
        for conf_path in reversed(conf_paths):
            conf_fpath = os.path.join(conf_path, 'spyder_e.ini')
        ...
        self.old_spyder_version = (
            self._user_config._configs_map['spyder_e']._old_version)
    ...
    def register_plugin(self, plugin_class):
        ...
        if plugin_class.CONF_FILE and conf_section:
            ...
            name_map = name_map if name_map else {'spyder_e': []}
    ...
    def remove_deprecated_config_locations(self):
        """Removing old .spyder_e.ini location."""
        old_location = osp.join(get_home_dir(), '.spyder_e.ini')
