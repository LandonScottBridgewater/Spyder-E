...
from spyder_e.config.user import DefaultsConfig, SpyderUserConfig, UserConfig
...
def spyderconfig_previous(tmpdir, mocker):
    ...
    mocker.patch('spyder_e.config.base', 'get_conf_path')
    inifile = tmpdir.join('{}.ini'.format(name))
