...
def is_py2exe_or_cx_Freeze():
    ...
    return osp.isfile(osp.join(get_module_path('spyder_e'), osp.pardir))
...
def get_available_translations():
    ...
    """
    locale_path = get_module_data_path("spyder_e", relpath="locale",
