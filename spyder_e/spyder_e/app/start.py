...
from spyder_e.config.base import (get_conf_path, reset_config_files,
                                running_under_pytest, is_conda_based_app)
from spyder_e.utils.conda import get_conda_root_prefix
...
def main():
    ...
    if options.paths:
        from spyder_e.config.base import get_conf_paths
        sys.stdout.write('\nconfig:' + '\n')
    ...
    if (CONF.get('main', 'single_instance') and not options.new_instance
        ...
        # Try to lock spyder_e.lock. If it's *possible* to do it, then
        ...
        try:
            ...
            # module, try to remove a possibly stale spyder_e.lock.
            ...
            # sense
            from spyder_e.app import mainwindow
            if running_under_pytest():
