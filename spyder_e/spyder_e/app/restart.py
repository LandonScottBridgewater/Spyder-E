...
from spyder_e.app.utils import create_splash_screen
from spyder_e.utils.image_path_manager import get_image_path
from spyder_e.utils.encoding import to_unicode
...
class Restarter(QWidget):
    ...
    def launch_error_message(self, error_type, error=None):
        ...
        error_type : int [CLOSE_ERROR, RESET_ERROR, RESTART_ERROR]
            Possible error codes when restarting/resetting spyder_e.
        error : Exception
...
def main():
    ...
    if is_bootstrap:
        ...
        script = osp.join(spyder_dir, 'spyder_e', 'app', 'start.py')
