...
#==============================================================================
from spyder_e import requirements
...
#==============================================================================
from spyder_e import __version__
from spyder_e.app.find_plugins import (
    find_external_plugins, find_internal_plugins)
from spyder_e.app.utils import (
...
from spyder_e.api.plugin_registration.registry import PLUGIN_REGISTRY
from spyder_e.api.shortcuts import SpyderShortcutsMixin
from spyder_e.api.translations import _
from spyder_e.api.widgets.mixins import SpyderMainWindowMixin
from spyder_e.config.base import (DEV, get_conf_path, get_debug_level,
                                get_home_dir, is_conda_based_app,
                                running_under_pytest, STDERR)
from spyder_e.config.gui import is_dark_font_color
from spyder_e.config.main import OPEN_FILES_PORT
from spyder_e.config.manager import CONF
from spyder_e.utils import encoding, programs
from spyder_e.utils.icon_manager import ima
from spyder_e.utils.misc import select_port, getcwd_or_home
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.qthelpers import qapplication
from spyder_e.utils.stylesheet import APP_STYLESHEET

# Spyder API Imports
from spyder_e.api.exceptions import SpyderAPIError
from spyder_e.api.plugins import Plugins, SpyderDockablePlugin, SpyderPluginV2
...
if os.name == 'nt':
    from spyder_e.utils.windows import (set_attached_console_visible,
...
class MainWindow(QMainWindow, SpyderMainWindowMixin, SpyderShortcutsMixin):
    ...
    def setup(self):
        ...
        from spyder_e.plugins.help.utils.sphinxify import CSS_PATH, DARK_CSS_PATH
...
def main(options, args):
    ...
    if options.reset_to_defaults:
        ...
        programs.run_python_script(module="compileall",
                                   args=[spyder_e.__path__[0]], p_args=['-O'])
        return
