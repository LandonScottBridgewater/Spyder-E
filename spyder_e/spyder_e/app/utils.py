...
from spyder_e.utils.external.dafsa.dafsa import DAFSA
from spyder_e.utils.image_path_manager import get_image_path
from spyder_e.utils.installers import running_installer_test
from spyder_e.utils.palette import SpyderPalette
from spyder_e.utils.qthelpers import file_uri, qapplication
...
class Spy:
    ...
    Attributes:
        ...
        window    Reference to spyder_e.MainWindow widget
    """
...
def create_application():
    ...
    # ---- Set icon
    app_icon = QIcon(get_image_path("spyder_e"))
    ...
    try:
        ...
        if running_under_pytest():
            ...
            from spyder_e.config.fonts import MEDIUM, MONOSPACE
    ...
    if hasattr(app, 'setDesktopFileName'):
        app.setDesktopFileName('spyder_e')
